...
## Contents
- `boards/`: Shared Zephyr board definitions for MSPM0 firmware apps. `boards/arm/mikrobus_hat/` is the single source of truth for the MSPM0L1105 HAT controller board.
- `blinky/`: Minimal Zephyr GPIO validation app used to prove board support and flashing on the MSPM0L1105.
