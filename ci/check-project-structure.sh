...
required_paths=(
  ...
  "firmware/host-integration/linux/beagley-ai/jkembedded-mikrobus-hat.dts"
  "firmware/host-integration/linux/sk-am62/jkembedded-mikrobus-hat.dts"
  "firmware/host-integration/linux/sk-am68/jkembedded-mikrobus-hat.dts"
  "firmware/host-integration/linux/sk-am69/jkembedded-mikrobus-hat.dts"
)
